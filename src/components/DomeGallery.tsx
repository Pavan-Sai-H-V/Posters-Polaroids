...
export default function DomeGallery({
  ...
  dragDampening = 2,
  openedImageWidth = typeof window !== 'undefined' && window.innerWidth <= 640 ? '250px' : '500px',
  openedImageHeight = typeof window !== 'undefined' && window.innerWidth <= 640 ? '250px' : '500px',
  imageBorderRadius = typeof window !== 'undefined' && window.innerWidth <= 640 ? '16px' : '30px',
  openedImageBorderRadius = typeof window !== 'undefined' && window.innerWidth <= 640 ? '16px' : '30px',
  grayscale = true
}: DomeGalleryProps) {
