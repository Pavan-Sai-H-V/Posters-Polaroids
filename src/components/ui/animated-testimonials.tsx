    ...
    <div className="mx-auto max-w-sm px-4 py-8 md:py-12 lg:py-20 font-sans antialiased md:max-w-4xl md:px-8 lg:px-12">
      <div className="relative grid grid-cols-1 gap-8 md:gap-20 md:grid-cols-2">
        ...
        <div className="flex flex-col justify-between py-2 md:py-4">
          ...
          <div className="flex gap-3 md:gap-4 pt-6 md:pt-12">
            <button
              onClick={handlePrev}
              className="group/button flex h-8 w-8 md:h-7 md:w-7 items-center justify-center rounded-full bg-gray-100 dark:bg-neutral-800"
            >
